...
"}")
        ...
        self.Cerrar_3 = QtWidgets.QPushButton(self.frame_Superior)
        self.Cerrar_3.setEnabled(True)
        self.Cerrar_3.setMinimumSize(QtCore.QSize(40, 40))
        self.Cerrar_3.setText("")
        icon = QtGui.QIcon()
        ...
        self.Cerrar_3.setIcon(icon)
        self.Cerrar_3.setIconSize(QtCore.QSize(41, 38))
        self.Cerrar_3.setObjectName("Cerrar_3")
        self.horizontalLayout.addWidget(self.Cerrar_3)
